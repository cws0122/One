	...
	<article>
		<div class="container">
			...
			<div id="boardWrite" class="nav justify-content-center mt-5 w-100" style="display:block;">
				<h3>게시글 작성</h3>
				<form id="writeForm" name="writeForm" class="border p-5 my-5 w-75" action="insertBoard.do" method="post" enctype="multipart/form-data">
					...
					<div id="buttons" class="w-100 nav justify-content-center">
						<button id="send" class="w-auto btn btn-md btn-primary border me-2" type="button">작성확인</button>
   						<button id="test" class="w-auto btn btn-md btn-light border" type="button" onclick="location.href='boardList.do'">돌아가기</button>
					</div>
				</form>
			</div>
